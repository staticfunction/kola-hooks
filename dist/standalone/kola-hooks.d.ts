...
export declare class ExecutionChainTimeout<T> implements Error {
    kommand: Kommand<T>;
    name: string;
    message: string;
...
export declare class ExecutionChainFactory<T> implements Hook<T> {
...
export declare function executes<T>(kommand: Kommand<T>[]): ExecutionChainFactory<T>;

export declare var kola: {
    hooks: {
        executes: <T>(kommand: Kommand<T>[]) => ExecutionChainFactory<T>
    }
}
